...
// This app's USFM-style 3-letter ids -> OSIS-style short book abbreviations
// (used by external tools like Bible Places that expect OSIS refs, e.g.
// "Acts.9.38"). Inverse of BOOK_ID_BY_ABBR in js/build-bible-metadata.js.
export const osisBookAbbr = {
  GEN: "Gen",
  EXO: "Exod",
  LEV: "Lev",
  NUM: "Num",
